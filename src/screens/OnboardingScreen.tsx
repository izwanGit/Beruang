...
export const OnboardingScreen = ({
  ...
  const questions = [
    ...
    },
    {
      ...
      keyboardType: 'default' as const,
      hint: 'How do you usually handle your money?',
      type: 'radio',
      options: [
        'Strict with every RM (Disciplined)',
        'Saves and spends wisely (Balanced)',
        'Spends whatever wants (Carefree)',
      ],
    },
    {
      id: 'trackingMethod',
      icon: 'magnify-expand',
      question: 'Money Tracking?',
      placeholder: 'How do you monitor?',
      value: trackingMethod,
      setValue: setTrackingMethod,
      keyboardType: 'default' as const,
      hint: 'Your current tracking habit.',
      type: 'radio',
      options: [
